...
// TestHost tests handling of host names and confirms that it matches github.com/smallerqiu/fhttp.
func TestHost(t *testing.T) {
	...
	// Avoid log noise from github.com/smallerqiu/fhttp server by logging to testing.T
	...
	for i, tt := range tests {
		...
		// Confirm that github.com/smallerqiu/fhttp has same result
...
func TestNextProtos(t *testing.T) {
	...
	// after the Client.Get call from github.com/smallerqiu/fhttp above.
